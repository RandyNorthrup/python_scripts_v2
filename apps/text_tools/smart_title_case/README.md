...
```bash
python3 smart_title_case.py
python3 smart_title_case.py "your input here"
```

Run `python3 smart_title_case.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
