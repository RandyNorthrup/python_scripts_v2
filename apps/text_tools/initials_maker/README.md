...
```bash
python3 initials_maker.py
python3 initials_maker.py "your input here"
```

Run `python3 initials_maker.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
