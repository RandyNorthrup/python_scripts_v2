...
```bash
python3 rot13_encoder.py
python3 rot13_encoder.py "your input here"
```

Run `python3 rot13_encoder.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
