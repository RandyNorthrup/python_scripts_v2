...
```bash
python3 sentence_stats.py
python3 sentence_stats.py "your input here"
```

Run `python3 sentence_stats.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
