...
```bash
python3 duplicate_line_remover.py
python3 duplicate_line_remover.py "your input here"
```

Run `python3 duplicate_line_remover.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
