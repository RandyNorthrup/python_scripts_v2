...
```bash
python3 vowel_histogram.py
python3 vowel_histogram.py "your input here"
```

Run `python3 vowel_histogram.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
