...
python3 caesar_cipher.py "your input here"
```

Run `python3 caesar_cipher.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
