...
python3 anagram_checker.py "your input here"
```

Run `python3 anagram_checker.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
