...
```bash
python3 morse_encoder.py
python3 morse_encoder.py "your input here"
```

Run `python3 morse_encoder.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
