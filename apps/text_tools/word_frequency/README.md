...
python3 word_frequency.py "your input here"
```

Run `python3 word_frequency.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
