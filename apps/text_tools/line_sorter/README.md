...
```bash
python3 line_sorter.py
python3 line_sorter.py "your input here"
```

Run `python3 line_sorter.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
