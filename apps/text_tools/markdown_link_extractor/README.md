...
```bash
python3 markdown_link_extractor.py
python3 markdown_link_extractor.py "your input here"
```

Run `python3 markdown_link_extractor.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
