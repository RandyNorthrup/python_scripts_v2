...
```bash
python3 reading_time.py
python3 reading_time.py "your input here"
```

Run `python3 reading_time.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
