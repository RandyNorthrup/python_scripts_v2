...
python3 word_counter.py "your input here"
```

Run `python3 word_counter.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
