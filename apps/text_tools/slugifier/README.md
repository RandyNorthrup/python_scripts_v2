...
```bash
python3 slugifier.py
python3 slugifier.py "your input here"
```

Run `python3 slugifier.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
