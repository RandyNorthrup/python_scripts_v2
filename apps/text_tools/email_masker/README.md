...
```bash
python3 email_masker.py
python3 email_masker.py "your input here"
```

Run `python3 email_masker.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
