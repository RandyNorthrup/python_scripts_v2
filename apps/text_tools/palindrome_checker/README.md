...
python3 palindrome_checker.py "your input here"
```

Run `python3 palindrome_checker.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
