...
```bash
python3 whitespace_cleaner.py
python3 whitespace_cleaner.py "your input here"
```

Run `python3 whitespace_cleaner.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
