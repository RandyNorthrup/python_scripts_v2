...
```bash
python3 worldbuilding_question.py
python3 worldbuilding_question.py --seed 7 --count 5
```

Run `python3 worldbuilding_question.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
