...
```bash
python3 recipe_idea.py
python3 recipe_idea.py --seed 7 --count 5
```

Run `python3 recipe_idea.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
