...
```bash
python3 poem_seed.py
python3 poem_seed.py --seed 7 --count 5
```

Run `python3 poem_seed.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
