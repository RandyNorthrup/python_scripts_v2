...
```bash
python3 metaphor_mixer.py
python3 metaphor_mixer.py --seed 7 --count 5
```

Run `python3 metaphor_mixer.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
