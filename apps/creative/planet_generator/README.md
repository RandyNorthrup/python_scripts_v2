...
python3 planet_generator.py --seed 7 --count 5
```

Run `python3 planet_generator.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
