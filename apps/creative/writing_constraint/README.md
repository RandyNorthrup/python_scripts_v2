...
```bash
python3 writing_constraint.py
python3 writing_constraint.py --seed 7 --count 5
```

Run `python3 writing_constraint.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
