...
```bash
python3 dungeon_room.py
python3 dungeon_room.py --seed 7 --count 5
```

Run `python3 dungeon_room.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
