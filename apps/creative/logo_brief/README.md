...
```bash
python3 logo_brief.py
python3 logo_brief.py --seed 7 --count 5
```

Run `python3 logo_brief.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
