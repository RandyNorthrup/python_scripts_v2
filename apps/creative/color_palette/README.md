...
```bash
python3 color_palette.py
python3 color_palette.py --seed 7 --count 5
```

Run `python3 color_palette.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
