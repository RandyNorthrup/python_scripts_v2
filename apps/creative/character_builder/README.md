...
python3 character_builder.py --seed 7 --count 5
```

Run `python3 character_builder.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
