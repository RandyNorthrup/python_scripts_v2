...
```bash
python3 superhero_generator.py
python3 superhero_generator.py --seed 7 --count 5
```

Run `python3 superhero_generator.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
