...
```bash
python3 fantasy_name.py
python3 fantasy_name.py --seed 7 --count 5
```

Run `python3 fantasy_name.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
