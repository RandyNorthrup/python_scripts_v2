...
```bash
python3 plot_twist.py
python3 plot_twist.py --seed 7 --count 5
```

Run `python3 plot_twist.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
