...
```bash
python3 comic_panel.py
python3 comic_panel.py --seed 7 --count 5
```

Run `python3 comic_panel.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
