...
```bash
python3 melody_pattern.py
python3 melody_pattern.py --seed 7 --count 5
```

Run `python3 melody_pattern.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
