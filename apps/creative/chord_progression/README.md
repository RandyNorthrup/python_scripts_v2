...
```bash
python3 chord_progression.py
python3 chord_progression.py --seed 7 --count 5
```

Run `python3 chord_progression.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
