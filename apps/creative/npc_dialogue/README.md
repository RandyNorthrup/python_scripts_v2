...
python3 npc_dialogue.py --seed 7 --count 5
```

Run `python3 npc_dialogue.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
