...
```bash
python3 trivia_challenge.py
python3 trivia_challenge.py --play --seed 7
```

Run `python3 trivia_challenge.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
