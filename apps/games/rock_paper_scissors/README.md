...
python3 rock_paper_scissors.py --play --seed 7
```

Run `python3 rock_paper_scissors.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
