...
python3 sliding_tiles.py --play --seed 7
```

Run `python3 sliding_tiles.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
