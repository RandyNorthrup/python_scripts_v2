...
```bash
python3 dice_duel.py
python3 dice_duel.py --play --seed 7
```

Run `python3 dice_duel.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
