...
```bash
python3 blackjack_lite.py
python3 blackjack_lite.py --play --seed 7
```

Run `python3 blackjack_lite.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
