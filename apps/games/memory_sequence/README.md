...
```bash
python3 memory_sequence.py
python3 memory_sequence.py --play --seed 7
```

Run `python3 memory_sequence.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
