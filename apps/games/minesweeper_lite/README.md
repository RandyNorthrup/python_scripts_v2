...
```bash
python3 minesweeper_lite.py
python3 minesweeper_lite.py --play --seed 7
```

Run `python3 minesweeper_lite.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
