...
```bash
python3 battleship_shot.py
python3 battleship_shot.py --play --seed 7
```

Run `python3 battleship_shot.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
