...
```bash
python3 nim_stones.py
python3 nim_stones.py --play --seed 7
```

Run `python3 nim_stones.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
