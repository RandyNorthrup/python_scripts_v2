...
```bash
python3 math_race.py
python3 math_race.py --play --seed 7
```

Run `python3 math_race.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
