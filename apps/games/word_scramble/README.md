...
python3 word_scramble.py --play --seed 7
```

Run `python3 word_scramble.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
