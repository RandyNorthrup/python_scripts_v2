...
```bash
python3 coin_streak.py
python3 coin_streak.py --play --seed 7
```

Run `python3 coin_streak.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
