...
```bash
python3 tiny_adventure.py
python3 tiny_adventure.py --play --seed 7
```

Run `python3 tiny_adventure.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
