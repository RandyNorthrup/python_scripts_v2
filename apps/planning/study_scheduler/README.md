...
```bash
python3 study_scheduler.py
python3 study_scheduler.py --total-hours 15
```

Run `python3 study_scheduler.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
