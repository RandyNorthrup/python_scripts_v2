...
```bash
python3 debt_payoff.py
python3 debt_payoff.py --balance 9375
```

Run `python3 debt_payoff.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
