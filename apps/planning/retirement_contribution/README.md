...
```bash
python3 retirement_contribution.py
python3 retirement_contribution.py --salary 87500
```

Run `python3 retirement_contribution.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
