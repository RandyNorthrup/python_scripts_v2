...
```bash
python3 event_capacity.py
python3 event_capacity.py --guests 150
```

Run `python3 event_capacity.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
