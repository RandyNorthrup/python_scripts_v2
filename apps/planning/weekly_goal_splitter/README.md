...
```bash
python3 weekly_goal_splitter.py
python3 weekly_goal_splitter.py --goal 125
```

Run `python3 weekly_goal_splitter.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
