...
python3 commute_time.py --minutes-one-way 43.75
```

Run `python3 commute_time.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
