...
```bash
python3 workout_volume.py
python3 workout_volume.py --sets 5
```

Run `python3 workout_volume.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
