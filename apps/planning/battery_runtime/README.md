...
```bash
python3 battery_runtime.py
python3 battery_runtime.py --capacity-wh 625
```

Run `python3 battery_runtime.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
