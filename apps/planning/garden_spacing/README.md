...
```bash
python3 garden_spacing.py
python3 garden_spacing.py --length-m 3.75
```

Run `python3 garden_spacing.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
