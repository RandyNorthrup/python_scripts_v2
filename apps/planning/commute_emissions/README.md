...
```bash
python3 commute_emissions.py
python3 commute_emissions.py --distance-km 22.5
```

Run `python3 commute_emissions.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
