...
```bash
python3 pomodoro_plan.py
python3 pomodoro_plan.py --work-minutes 31.25
```

Run `python3 pomodoro_plan.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
