...
```bash
python3 meeting_cost.py
python3 meeting_cost.py --people 7.5
```

Run `python3 meeting_cost.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
