...
```bash
python3 freelance_rate.py
python3 freelance_rate.py --annual-income 100000
```

Run `python3 freelance_rate.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
