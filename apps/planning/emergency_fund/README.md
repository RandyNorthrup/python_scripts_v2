...
python3 emergency_fund.py --monthly-expenses 3500
```

Run `python3 emergency_fund.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
