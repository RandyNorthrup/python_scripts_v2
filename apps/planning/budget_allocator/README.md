...
python3 budget_allocator.py --income 5000
```

Run `python3 budget_allocator.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
