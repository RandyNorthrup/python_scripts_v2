...
python3 probability_basics.py --play --seed 7
```

Run `python3 probability_basics.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
