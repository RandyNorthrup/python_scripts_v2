...
```bash
python3 capital_cities.py
python3 capital_cities.py --play --seed 7
```

Run `python3 capital_cities.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
