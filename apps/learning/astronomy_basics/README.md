...
```bash
python3 astronomy_basics.py
python3 astronomy_basics.py --play --seed 7
```

Run `python3 astronomy_basics.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
