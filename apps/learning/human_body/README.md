...
```bash
python3 human_body.py
python3 human_body.py --play --seed 7
```

Run `python3 human_body.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
