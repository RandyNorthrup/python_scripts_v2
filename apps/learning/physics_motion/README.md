...
```bash
python3 physics_motion.py
python3 physics_motion.py --play --seed 7
```

Run `python3 physics_motion.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
