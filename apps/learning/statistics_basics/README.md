...
```bash
python3 statistics_basics.py
python3 statistics_basics.py --play --seed 7
```

Run `python3 statistics_basics.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
