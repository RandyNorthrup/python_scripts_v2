...
```bash
python3 fraction_skills.py
python3 fraction_skills.py --play --seed 7
```

Run `python3 fraction_skills.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
