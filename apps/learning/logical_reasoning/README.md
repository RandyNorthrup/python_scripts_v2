...
```bash
python3 logical_reasoning.py
python3 logical_reasoning.py --play --seed 7
```

Run `python3 logical_reasoning.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
