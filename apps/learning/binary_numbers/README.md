...
```bash
python3 binary_numbers.py
python3 binary_numbers.py --play --seed 7
```

Run `python3 binary_numbers.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
