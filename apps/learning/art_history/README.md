...
```bash
python3 art_history.py
python3 art_history.py --play --seed 7
```

Run `python3 art_history.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
