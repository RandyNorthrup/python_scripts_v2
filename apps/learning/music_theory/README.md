...
```bash
python3 music_theory.py
python3 music_theory.py --play --seed 7
```

Run `python3 music_theory.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
