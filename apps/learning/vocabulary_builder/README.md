...
python3 vocabulary_builder.py --play --seed 7
```

Run `python3 vocabulary_builder.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
