...
```bash
python3 computer_networks.py
python3 computer_networks.py --play --seed 7
```

Run `python3 computer_networks.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
