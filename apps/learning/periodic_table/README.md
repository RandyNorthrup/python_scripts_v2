...
python3 periodic_table.py --play --seed 7
```

Run `python3 periodic_table.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
