...
```bash
python3 multiplication_trainer.py
python3 multiplication_trainer.py --play --seed 7
```

Run `python3 multiplication_trainer.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
