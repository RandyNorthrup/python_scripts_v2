...
python3 disk_usage_report.py /path/to/file-or-directory
```

Run `python3 disk_usage_report.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
