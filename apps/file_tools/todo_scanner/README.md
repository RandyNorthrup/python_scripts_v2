...
python3 todo_scanner.py /path/to/file-or-directory
```

Run `python3 todo_scanner.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
