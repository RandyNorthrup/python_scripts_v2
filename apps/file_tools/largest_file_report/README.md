...
```bash
python3 largest_file_report.py
python3 largest_file_report.py /path/to/file-or-directory
```

Run `python3 largest_file_report.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
