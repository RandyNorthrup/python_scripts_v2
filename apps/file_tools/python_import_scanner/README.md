...
```bash
python3 python_import_scanner.py
python3 python_import_scanner.py /path/to/file-or-directory
```

Run `python3 python_import_scanner.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
