...
```bash
python3 batch_rename_preview.py
python3 batch_rename_preview.py /path/to/file-or-directory
```

Run `python3 batch_rename_preview.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
