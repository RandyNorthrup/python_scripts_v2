...
```bash
python3 ini_inspector.py
python3 ini_inspector.py /path/to/file-or-directory
```

Run `python3 ini_inspector.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
