...
python3 csv_summary.py /path/to/file-or-directory
```

Run `python3 csv_summary.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
