...
python3 directory_tree.py /path/to/file-or-directory
```

Run `python3 directory_tree.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
