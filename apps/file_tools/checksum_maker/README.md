...
```bash
python3 checksum_maker.py
python3 checksum_maker.py /path/to/file-or-directory
```

Run `python3 checksum_maker.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
