...
```bash
python3 empty_file_finder.py
python3 empty_file_finder.py /path/to/file-or-directory
```

Run `python3 empty_file_finder.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
