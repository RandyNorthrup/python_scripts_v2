...
```bash
python3 line_statistics.py
python3 line_statistics.py /path/to/file-or-directory
```

Run `python3 line_statistics.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
