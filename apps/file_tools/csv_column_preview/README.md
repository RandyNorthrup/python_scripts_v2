...
```bash
python3 csv_column_preview.py
python3 csv_column_preview.py /path/to/file-or-directory
```

Run `python3 csv_column_preview.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
