...
python3 log_level_counter.py /path/to/file-or-directory
```

Run `python3 log_level_counter.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
