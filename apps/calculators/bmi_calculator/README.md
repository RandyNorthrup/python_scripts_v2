...
python3 bmi_calculator.py --weight-kg 90
```

Run `python3 bmi_calculator.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
