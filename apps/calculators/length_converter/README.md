...
python3 length_converter.py --meters 6.25
```

Run `python3 length_converter.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
