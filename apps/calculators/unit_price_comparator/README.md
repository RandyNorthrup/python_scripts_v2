...
```bash
python3 unit_price_comparator.py
python3 unit_price_comparator.py --price-a 10.6125
```

Run `python3 unit_price_comparator.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
