...
```bash
python3 percentage_change.py
python3 percentage_change.py --old-value 100
```

Run `python3 percentage_change.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
