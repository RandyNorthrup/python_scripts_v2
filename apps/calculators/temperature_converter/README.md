...
python3 temperature_converter.py --celsius 27.5
```

Run `python3 temperature_converter.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
