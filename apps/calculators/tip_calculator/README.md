...
python3 tip_calculator.py --subtotal 80
```

Run `python3 tip_calculator.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
