...
```bash
python3 paint_estimator.py
python3 paint_estimator.py --wall-width 5.625
```

Run `python3 paint_estimator.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
