...
```bash
python3 recipe_scaler.py
python3 recipe_scaler.py --amount 3.125
```

Run `python3 recipe_scaler.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
