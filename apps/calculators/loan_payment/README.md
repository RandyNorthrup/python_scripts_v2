...
```bash
python3 loan_payment.py
python3 loan_payment.py --principal 25000
```

Run `python3 loan_payment.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
