...
```bash
python3 time_zone_offset.py
python3 time_zone_offset.py --hour 18.125
```

Run `python3 time_zone_offset.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
