...
```bash
python3 data_size_converter.py
python3 data_size_converter.py --byte-count 1.31072e+06
```

Run `python3 data_size_converter.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
