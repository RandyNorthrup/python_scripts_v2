...
```bash
python3 age_in_days.py
python3 age_in_days.py --years 31.25
```

Run `python3 age_in_days.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
