...
```bash
python3 fuel_cost.py
python3 fuel_cost.py --distance-km 562.5
```

Run `python3 fuel_cost.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
