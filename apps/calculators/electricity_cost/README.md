...
```bash
python3 electricity_cost.py
python3 electricity_cost.py --watts 1125
```

Run `python3 electricity_cost.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
