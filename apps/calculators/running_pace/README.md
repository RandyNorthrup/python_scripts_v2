...
```bash
python3 running_pace.py
python3 running_pace.py --distance-km 12.5
```

Run `python3 running_pace.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
