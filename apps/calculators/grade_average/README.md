...
python3 grade_average.py --score-a 110
```

Run `python3 grade_average.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
