...
```bash
python3 screen_ppi.py
python3 screen_ppi.py --width-px 3200
```

Run `python3 screen_ppi.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
