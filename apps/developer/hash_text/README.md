...
```bash
python3 hash_text.py
python3 hash_text.py "your input here"
```

Run `python3 hash_text.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
