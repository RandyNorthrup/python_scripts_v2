...
python3 base64_encoder.py "your input here"
```

Run `python3 base64_encoder.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
