...
```bash
python3 chmod_calculator.py
python3 chmod_calculator.py "your input here"
```

Run `python3 chmod_calculator.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
