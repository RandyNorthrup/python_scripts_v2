...
```bash
python3 lorem_generator.py
python3 lorem_generator.py "your input here"
```

Run `python3 lorem_generator.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
