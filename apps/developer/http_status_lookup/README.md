...
```bash
python3 http_status_lookup.py
python3 http_status_lookup.py "your input here"
```

Run `python3 http_status_lookup.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
