...
python3 unix_timestamp.py "your input here"
```

Run `python3 unix_timestamp.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
