...
```bash
python3 deterministic_uuid.py
python3 deterministic_uuid.py "your input here"
```

Run `python3 deterministic_uuid.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
