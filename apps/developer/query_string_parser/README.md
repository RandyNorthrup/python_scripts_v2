...
```bash
python3 query_string_parser.py
python3 query_string_parser.py "your input here"
```

Run `python3 query_string_parser.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
