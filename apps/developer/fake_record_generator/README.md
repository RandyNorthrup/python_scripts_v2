...
```bash
python3 fake_record_generator.py
python3 fake_record_generator.py "your input here"
```

Run `python3 fake_record_generator.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
