...
```bash
python3 markdown_table_maker.py
python3 markdown_table_maker.py "your input here"
```

Run `python3 markdown_table_maker.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
