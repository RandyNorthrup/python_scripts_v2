...
```bash
python3 cron_explainer.py
python3 cron_explainer.py "your input here"
```

Run `python3 cron_explainer.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
