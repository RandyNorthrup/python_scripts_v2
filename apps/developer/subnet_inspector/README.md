...
```bash
python3 subnet_inspector.py
python3 subnet_inspector.py "your input here"
```

Run `python3 subnet_inspector.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
