...
```bash
python3 text_to_hex.py
python3 text_to_hex.py "your input here"
```

Run `python3 text_to_hex.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
