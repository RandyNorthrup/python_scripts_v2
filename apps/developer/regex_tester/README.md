...
python3 regex_tester.py "your input here"
```

Run `python3 regex_tester.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
