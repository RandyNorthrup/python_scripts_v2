...
```bash
python3 unified_diff.py
python3 unified_diff.py "your input here"
```

Run `python3 unified_diff.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
