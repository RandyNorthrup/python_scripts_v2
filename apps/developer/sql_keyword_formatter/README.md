...
```bash
python3 sql_keyword_formatter.py
python3 sql_keyword_formatter.py "your input here"
```

Run `python3 sql_keyword_formatter.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
