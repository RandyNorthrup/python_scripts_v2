...
python3 color_converter.py "your input here"
```

Run `python3 color_converter.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
