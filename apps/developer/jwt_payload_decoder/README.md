...
```bash
python3 jwt_payload_decoder.py
python3 jwt_payload_decoder.py "your input here"
```

Run `python3 jwt_payload_decoder.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
