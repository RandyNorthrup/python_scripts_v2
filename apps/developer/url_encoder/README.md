...
```bash
python3 url_encoder.py
python3 url_encoder.py "your input here"
```

Run `python3 url_encoder.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
