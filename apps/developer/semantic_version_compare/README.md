...
```bash
python3 semantic_version_compare.py
python3 semantic_version_compare.py "your input here"
```

Run `python3 semantic_version_compare.py --help` for every option. Interactive quizzes and games only prompt when `--play` is supplied.
